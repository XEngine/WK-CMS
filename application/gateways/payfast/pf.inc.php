<?php
   ...
   * by the Free Software Foundation; either version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
   * your option) any later version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
   * 
  ...
  define('PF_SOFTWARE_NAME', 'Freelance-Manager');
  define('PF_SOFTWARE_VER', "3.0");
  define('PF_MODULE_NAME', 'PayFast-Freelance-Manager');
  define('PF_MODULE_VER', '1.0');

  // Features
  $pfFeatures = 'PHP ' . phpversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.

  // - cURL
  if (in_array('curl', get_loaded_extensions())) {
      $pfversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.
      $pfFeatures .= ' curl ' . $pfversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.
  } else
      $pfFeatures .= ' nocurl;';
