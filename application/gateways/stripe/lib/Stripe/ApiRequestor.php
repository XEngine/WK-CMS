...
class Stripe_ApiRequestor
{
  ...
  private function _requestRaw($meth, $url, $params)
  {
    ...
    $langversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.
    $uname = php_uname();
    $ua = array('bindings_version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
		'lang' => 'php',
		'lang_version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
		'publisher' => 'stripe',
		'uname' => $uname);
    $headers = array('X-Stripe-Client-User-Agent: ' . json_encode($ua),
		     'User-Agent: Stripe/v1 PhpBindings/' . Stripe::version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
                     'Authorization: Bearer ' . $myApiKey);
    if (Stripe::$apiversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.
      $headers[] = 'Stripe-version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
