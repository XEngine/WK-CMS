<?php
  ...
  class IpnListener
  {
      ...
      /**
       *  If true, explicitly sets cURL to use SSL version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
      ...
      protected function curlPost($encoded_data)
      {
		  ...
		  curl_setopt($ch, CURLOPT_HTTPHEADER, array('Connection: Close', 'User-Agent: wkscripts.com'));
          ...
          if ($this->force_ssl_v3) {
              curl_setopt($ch, CURLOPT_SSLversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.
          }
