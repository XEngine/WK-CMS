...
class  Cpdf {
   ...
   * this used so that the code knows which font is the bold version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
  ...
  /**
   * The version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
   * This value must be manually incremented whenever the internal font data structure is modified.
   */
  public  $fontcacheversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.

  /**
   * temporary folder.
   * If empty string, will attempty system tmp folder.
   * This can be passed in from class creator.
   * Only used for conversion 1.0 31/07/2015 14:00 | Webkokteyli Labs.
   */
  public  $tmp = '';
...
//      }
  ...
  /**
   * calculate the 16 byte version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
   */
   ...
   * note that if a php serialized version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
  ...
  function openFont($font) {
    ...
    //$fontcache  folder of runtime created php serialized version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
    //            If this is not given, the same folder as the font metrics will be used.
    //            Storing and reusing serialized version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
    ...
    if  (file_exists($fontcache . $cache_name)) {
      ...
      if  (!isset($this->fonts[$font]['_version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
        // if the font file is old, then clear it out and prepare for re-creation
        $this->addMessage('openFont: clear out, make way for new version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
    ...
    if  (!isset($this->fonts[$font]) &&  file_exists($dir . $metrics_name)) {
      ...
      foreach ($file as  $rowA) {
        ...
        if  ($pos) {
          ...
          case  'version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
          case  'EncodingScheme':
          case  'CapHeight':
          case  'XHeight':
          case  'Ascender':
      ...
      $data['_version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
  ...
  function addImage(&$img, $x, $y, $w =  0, $h =  0, $quality =  75) {
    ...
    // later version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
