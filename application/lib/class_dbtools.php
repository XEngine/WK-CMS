<?php
  ...
  class dbTools
  {
      ...
      private function fetch()
      {
          ...
          $dump .= '-- --------------------------------------------------------------------------------' . self::nl;
          $dump .= '-- ' . self::nl;
          $dump .= '-- @version 1.0 31/07/2015 14:00 | Webkokteyli Labs.';
          $dump .= '-- @package wk:cms' . self::nl;
          $dump .= '-- @author Webkokteyli Lab / http://www.webkokteyli.com.' . self::nl;
          ...
          $dump .= '-- MySQL version 1.0 31/07/2015 14:00 | Webkokteyli Labs.';
          $dump .= '-- PHP version 1.0 31/07/2015 14:00 | Webkokteyli Labs.';
