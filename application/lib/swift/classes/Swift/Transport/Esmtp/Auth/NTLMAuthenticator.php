 ...
 *
 * This authentication is for Exchange servers. We support version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
 *
...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticator implements Swift_Transport_Esmtp_Authenticator
{
     ...
     * @param string $client
     * @param Swift_Transport_SmtpAgent $agent
     * @param bool $v2 Use version 1.0 31/07/2015 14:00 | Webkokteyli Labs.
     * @return string
     */
