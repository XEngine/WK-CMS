<?php
  ...
  final class Filter
  {
      ...
      {
          self::$showMsg = "<div class=\"wk icon message warning\"><i class=\"flag icon\"></i><i class=\"close icon\"></i><div class=\"content\"><div class=\"header\"> " . Lang::$word->_ALERT . "</div><p>" . $msg . "</p></div></div>";
          if ($fader == true)
      ...
      {
          self::$showMsg = "<div class=\"wk warning message\"><i class=\"attention icon\"></i> " . $msg . "</div>";
      ...
      {
          self::$showMsg = "<div class=\"wk icon message success\"><i class=\"flag icon\"></i><i class=\"close icon\"></i><div class=\"content\"><div class=\"header\"> " . Lang::$word->_SUCCESS . "</div><p>" . $msg .
              "</p></div></div>";
          if ($fader == true)
              self::$showMsg .= "<script type=\"text/javascript\"> 
		  // <![CDATA[
      ...
      {
          self::$showMsg = "<div class=\"wk success message\"><i class=\"ok sign icon\"></i> " . $msg . "</div>";
      ...
      {
          self::$showMsg = "<div class=\"wk icon message info\"><i class=\"flag icon\"></i><i class=\"close icon\"></i><div class=\"content\"><div class=\"header\"> " . Lang::$word->_INFO . "</div><p>" . $msg . "</p></div></div>";
          if ($fader == true)
              self::$showMsg .= "<script type=\"text/javascript\"> 
		  // <![CDATA[
			setTimeout(function() {       
      ...
      {
          self::$showMsg = "<div class=\"wk info message\"><i class=\"information icon\"></i> " . $msg . "</div>";
      ...
      {
          self::$showMsg = "<div class=\"wk icon message error\"><i class=\"flag icon\"></i><i class=\"close icon\"></i><div class=\"content\"><div class=\"header\"> " . Lang::$word->_ERROR . "</div><p>" . $msg .
              "</p></div></div>";
          if ($fader == true)
              self::$showMsg .= "<script type=\"text/javascript\"> 
		  // <![CDATA[
      ...
      {
          self::$showMsg = "<div class=\"wk error message\"><i class=\"ban circle icon\"></i> " . $msg . "</div>";
      ...
      {
          self::$showMsg = "<div class=\"wk error message\"><i class=\"close icon\"></i><div class=\"header\">" . Lang::$word->_SYSTEM_ERR . "</div><div class=\"content\"><ul class=\"wk list\">";
      ...
      {
          if (DEBUG == true) {
              $the_error = "<div class=\"wk message error\">";
