...
<div class="elastic-slideshow">
  <div id="ei-slider" class="ei-slider" style="height:<?php echo Registry::get("Elastic")->height;?>px">
    <ul class="ei-slider-large">
      ...
      <li><img src="<?php echo BASEPATH . '/' . Elastic::imgPath . $eslrow->thumb;?>" alt="<?php echo $eslrow->thumb;?>" />
        <div class="ei-title">
    ...
    <ul class="ei-slider-thumbs">
      ...
      <?php foreach ($slides as $eslrow):?>
      <li><a href="#"><?php echo $eslrow->{'title' . Lang::$lang};?></a><img src="<?php echo BASEPATH . '/' . Elastic::imgPath . $eslrow->thumb;?>" alt="<?php echo $eslrow->{'title' . Lang::$lang};?>" /></li>
      <?php endforeach;?>
    </ul>
  </div>
</div>
