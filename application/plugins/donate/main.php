...
<!-- Start Donations -->
<div id="donations">
<div class="wk striped danger active progress small-top-space" data-percent="<?php echo $percentage;?>">
  <div style="width:<?php echo $percentage;?>%" class="bar"><?php echo $percentage;?>%</div>
</div>
<div class="wk two fluid buttons small-top-space small-bottom-space">
  <div class="wk info button"><?php echo $core->cur_symbol . number_format($total, 2, '.', ',');?></div>
  <div class="wk warning button"><?php echo LANG::$word->_PLG_DP_TARGET1;?> <?php echo $core->cur_symbol . number_format($donate->atarget, 2, '.', ',');?></div>
</div>
