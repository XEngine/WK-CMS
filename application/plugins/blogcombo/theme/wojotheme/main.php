...
<div id="artcombo" class="clearfix">
  <div id="blgtabs" class="wtabs">
    ...
    <div id="pop" class="wk tab content"> 
      ...
      <?php if($popular):?>
      <div class="wk divided inverted list">
        <?php foreach ($popular as $poprow):?>
        <div class="item">
          <?php if($poprow->thumb):?>
          <a href="<?php echo SITEURL;?>/modules/blog/dataimages/<?php echo $poprow->thumb;?>" title="<?php echo $poprow->imgcap;?>" class="lightbox"><img src="<?php echo SITEURL;?>/thumbmaker.php?src=/<?php echo MODURL;?>blog/dataimages/<?php echo $poprow->thumb;?>&amp;h=50&amp;w=50&amp;a=t" alt="" class="wk image small-right-space"></a>
          <?php endif;?>
          <div class="content">
