...
<div class="wk buttons"> <a href="<?php echo Url::Portfolio("portfolio");?>" class="wk black button"><span><?php echo Lang::$word->_MOD_PF_ALL;?></span></a>
  ...
  <a class="wk <?php echo ($content->_url[2] == $fcrow->slug)? "info" : "black";?> button" href="<?php echo Url::Portfolio("portfolio-cat", $fcrow->slug);?>" data-category="<?php echo $fcrow->id;?>"><?php echo $fcrow->{'title'.Lang::$lang};?></a>
  <?php endforeach;?>
</div>
<?php endif;?>
...
<div id="folio-single">
  ...
  <div id="pftabs" class="wtabs">
    ...
    <div id="tab1" class="wk tab content">
      <div class="wk-content"><?php echo cleanOut($row->{'detail'.Lang::$lang});?> </div>
    </div>
    <div id="tab2" class="wk tab content">
      <div class="wk-content"><?php echo cleanOut($row->{'body'.Lang::$lang});?> </div>
    </div>
    <div id="tab3" class="wk tab content">
      <div class="wk-content"><?php echo cleanOut($row->{'result'.Lang::$lang});?> </div>
    </div>
  </div>
</div>
<?php break;?>
...
<?php if($catrow):?>
<div class="wk buttons"> <a class="wk info button"><span><?php echo Lang::$word->_MOD_PF_ALL;?></span></a>
