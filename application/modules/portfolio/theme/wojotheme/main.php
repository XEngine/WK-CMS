...
<?php if($catsrow):?>
<div class="wk basic buttons"> <a href="<?php echo Url::Portfolio("portfolio");?>" class="wk black button"><span><?php echo Lang::$word->_MOD_PF_ALL;?></span></a>
  <?php foreach($catsrow as $fcrow):?>
  <a class="wk <?php echo ($content->_url[2] == $fcrow->slug)? "active" : "black";?> button" href="<?php echo Url::Portfolio("portfolio-cat", $fcrow->slug);?>" data-category="<?php echo $fcrow->id;?>"><?php echo $fcrow->{'title'.Lang::$lang};?></a>
  <?php endforeach;?>
</div>
<?php endif;?>
...
<div id="folio-single">
  <div class="columns gutters">
    ...
    <div class="screen-50 tablet-50 phone-100"> <?php echo cleanOut($row->{'short_desc'.Lang::$lang});?>
      ...
      <a href="<?php echo Url::Portfolio("portfolio");?>" class="wk basic labeled icon button"><i class="left arrow icon"></i><?php echo Lang::$word->_MOD_PF_BACK;?></a> </div>
  </div>
...
<?php if($catrow):?>
<div class="wk basic buttons"> <a class="wk active button"><span><?php echo Lang::$word->_MOD_PF_ALL;?></span></a>
