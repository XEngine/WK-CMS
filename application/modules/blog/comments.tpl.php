...
<h4 class="wk header"><?php echo ($row->totalcomments <> 0) ?  $row->totalcomments . " " . Lang::$word->_MOD_AMC_COMMENTS_C . "<em>" . $row->{'title' . Lang::$lang} . "</em>" : Lang::$word->_MOD_AMC_NOCOMMENTS;?></h4>
