...
<?php Filter::msgAlert(Lang::$word->_SR_SEARCH_EMPTY . '<span class="wk black label">'.$tagname.'</span>' . Lang::$word->_SR_SEARCH_EMPTY1);?>
<?php else:?>
<h1 class="wk double header"><span><?php echo '<small class="wk label">' . count($latestrow) . '</small> ' .Lang::$word->_MOD_AMT_RESFOR . $tagname;?></span></h1>
