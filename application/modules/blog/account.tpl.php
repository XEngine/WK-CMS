...
<div class="wk secondary segment">
  <div class="clearfix"> <a onclick="$('#articleForm').slideToggle();" class="wk icon positive button push-right"><i class="icon add"></i> <?php echo Lang::$word->_MOD_AM_SUBTITLE4;?></a>
  ...
  <div id="articleForm" class="wk form" style="display:none">
    <form id="wk_form" name="wk_form" method="post">
      <div class="two fields">
        ...
        <div class="field">
          ...
          <p class="wk note info"><?php echo Lang::$word->_MOD_AM_SLUG_T;?></p>
        </div>
      </div>
      <div class="two fields">
        <div class="field">
        ...
        <div class="field">
          ...
          <p class="wk note info"><?php echo Lang::$word->_MOD_AM_IMAGE_T;?></p>
          ...
          <p class="wk note info"><?php echo Lang::$word->_MOD_AM_FILE_ATT_T;?></p>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <p class="wk note info"><?php echo Lang::$word->_MOD_AM_TAGS_T;?></p>
      </div>
      <div class="wk fitted divider"></div>
      <div class="field">
      ...
      <button data-url="/modules/blog/controller.php" type="button" name="doartsubmit" class="wk positive button"><i class="icon add"></i> <?php echo Lang::$word->_MOD_AM_SUBTITLE4;?></button>
  ...
  <table class="wk sortable table">
    ...
    <tbody>
      ...
      <tr>
        <td><a class="lightbox" href="<?php echo SITEURL . '/' . Blog::imagepath . $arow->thumb;?>" title="<?php echo $arow->{'title'.Lang::$lang};?>"> <img src="<?php echo SITEURL;?>/thumbmaker.php?src=<?php echo SITEURL . '/' . Blog::imagepath . $arow->thumb;?>&amp;w=120&amp;h=60" alt="" class="wk image"></a></td>
