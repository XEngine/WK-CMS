  ...
  <article class="clearfix">
    ...
    <section>
      ...
      <figure class="small-top-space small-bottom-space">
        <div class="image-overlay wk right floated image"> <img src="<?php echo SITEURL;?>/thumbmaker.php?src=<?php echo SITEURL.'/'.Blog::imagepath . $row->thumb;?>&amp;h=150&amp;w=250&amp;s=1&amp;a=tl" alt="">
