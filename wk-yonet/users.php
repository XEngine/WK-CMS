...
<div class="wk icon heading message dust"><a class="helper wk top right info corner label" data-help="user"><i class="icon help"></i></a> <i class="user icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_UR_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_UR_SUBTITLE1 . $row->username;?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_UR_UPDATE;?></button>
      <a href="index.php?do=users" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_UR_INFO2. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_UR_SUBTITLE2;?></div>
    <div class="wk double fitted divider"></div>
    <form id="wk_form" name="wk_form" method="post">
      <div class="two fields">
        <div class="field">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_UR_ADD;?></button>
      <a href="index.php?do=users" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
      <input name="processUser" type="hidden" value="1">
      <?php if($user->userlevel == 8):?>
...
<div class="wk icon heading message dust"> <i class="icon user"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_UR_TITLE3;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_UR_INFO3;?></div>
  <div class="wk segment"> <a class="wk icon positive button push-right" href="index.php?do=users&amp;action=add"><i class="icon add"></i> <?php echo Lang::$word->_UR_ADD;?></a>
    <div class="wk header"><?php echo Lang::$word->_UR_SUBTITLE3;?></div>
    <div class="wk fitted divider"></div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php if($row->avatar):?>
            <img src="<?php echo UPLOADURL;?>avatars/<?php echo $row->avatar;?>" alt="<?php echo $user->username;?>" class="wk image avatar"/>
            <?php else:?>
            <img src="<?php echo UPLOADURL;?>avatars/blank.png" alt="<?php echo $row->username;?>" class="wk image avatar"/>
            <?php endif;?>
