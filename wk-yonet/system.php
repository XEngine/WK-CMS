...
?>
<div class="wk icon heading message mortar"> <i class="laptop icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_SYS_INFO;?></div>
  <div class="wk segment">
    ...
    <div id="cms" class="tab_content">
      <table class="wk two column table">
        <thead>
          <tr>
...
$(document).ready(function(){
    var url = 'http://www.wkscripts.com/version.json?callback=?';
    $.ajax({
        type: 'GET',
        url: url,
        async: false,
