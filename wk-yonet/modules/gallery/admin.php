...
<div class="wk icon heading message blue"> <a class="helper wk top right info corner label" data-help="gallery"><i class="icon help"></i></a> <i class="puzzle piece icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_GA_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_GA_SUBTITLE1 . $row->title;?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_GA_UPDATE;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=gallery" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_GA_INFO2. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_GA_SUBTITLE2;?></div>
    <div class="wk double fitted divider"></div>
    <form id="wk_form" name="wk_form" method="post">
      <div class="two fields">
        <div class="field">
      ...
      <div class="three fields">
        ...
        <div class="field">
          <label><?php echo Lang::$word->_MOD_GA_COLS;?></label>
          <input class="slrage" type="text" name="cols">
        </div>
      </div>
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_GA_ADDMOD_GALLERY;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=gallery" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
      <input name="processGallery" type="hidden" value="1">
    </form>
  </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_GA_INFO5;?></div>
  <div class="wk segment">
    <?php if(!$galdata):?>
    <?php Filter::msgInfo(Lang::$word->_MOD_GA_NOIMG);?>
    <?php else:?>
    <div id="sortable" class="wk medium images">
      <?php foreach($galdata as $row):?>
      <img id="list_<?php echo $row->id;?>"src="<?php echo SITEURL . '/' . Gallery::galpath . Registry::get("Gallery")->folder . '/' . $row->thumb;?>" alt="" class="wk image">
      <?php endforeach;?>
    </div>
    <?php endif;?>
  </div>
...
<?php $galdata = Registry::get("Gallery")->getGalleryImages();?>
<div class="wk icon heading message blue"> <a class="helper wk top right info corner label" data-help="gallery_upload"><i class="icon help"></i></a><i class="puzzle piece icon"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_MOD_GA_TITLE4;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_GA_INFO3;?></div>
  <div class="wk form segment">
    <div class="wk buttons push-right"><a onclick="$('#extra').slideToggle();" class="wk positive button"><i class="icon disk upload"></i><?php echo Lang::$word->_MOD_GA_ADD_IMG;?></a><a href="<?php echo Core::url("modules", "sort", Filter::$id);?>" class="wk info button"><i class="sort attributes icon"></i><?php echo Lang::$word->_MOD_GA_SORT;?></a></div>
    <div class="wk header"><?php echo Lang::$word->_MOD_GA_SUBTITLE3 . Registry::get("Gallery")->title;?></div>
    ...
    <?php Filter::msgInfo(Lang::$word->_MOD_GA_NOIMG);?>
    <?php endif;?>
    <div id="gallery" class="wk grid fitted">
      <?php if($galdata):?>
      <?php foreach($galdata as $row):?>
      <div class="item" id="list_<?php echo $row->id;?>"><a data-id="<?php echo $row->id;?>" data-name="<?php echo $row->{'title' . Lang::$lang};?>" class="imgdelete wk top right negative corner label"><i class="icon remove sign"></i></a> <a href="<?php echo SITEURL . '/' . Gallery::galpath . Registry::get("Gallery")->folder . '/' . $row->thumb;?>" class="lightbox" title="<?php echo $row->{'title' . Lang::$lang};?>"><img src="<?php echo SITEURL . '/' . Gallery::galpath . Registry::get("Gallery")->folder . '/' . $row->thumb;?>" alt="" class="wk image"></a>
        <div class="wk-content">
          <div contenteditable="true" data-path="false" data-edit-type="gallery" data-id="<?php echo $row->id;?>" data-key="title" class="wk editable"><?php echo $row->{'title' . Lang::$lang};?></div>
          <div class="wk small divider"></div>
          <div contenteditable="true" data-path="false" data-edit-type="gallery" data-id="<?php echo $row->id;?>" data-key="desc" class="wk editable"><?php echo $row->{'description' . Lang::$lang};?></div>
        </div>
      </div>
      <?php endforeach;?>
      <?php endif;?>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_GA_INFO4;?></div>
  <div class="wk segment"> <a class="wk icon warning button push-right" href="<?php echo Core::url("modules", "add");?>"><i class="icon add"></i> <?php echo Lang::$word->_MOD_GA_ADDNEW;?></a>
    <div class="wk header"><?php echo Lang::$word->_MOD_GA_SUBTITLE4;?></div>
    <div class="wk fitted divider"></div>
