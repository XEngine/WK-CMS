(function ($, doc, win) {
    ...
    wkGrid.prototype.init = function () {
    ...
    wkGrid.prototype.getColumnsCount = function () {
    ...
    wkGrid.prototype.onNewContentLoaded = function () {
        this.$el.elasticColumns('refresh');
        this.displayItems();
    };

    wkGrid.prototype.displayItems = function () {
        var delay = 0;
    ...
    $.fn.wkGrid = function (opts) {
        return this.each(function () {
            new wkGrid(this, opts);
        });
    };
    wkGrid.prototype.onDeleteImage = function () {
        $('body').on('click', '#slidedata a.wk.label', $.proxy(function (e) {
    ...
    wkGrid.prototype.fileUpload = function () {
        var ul = $('#upload ul');
