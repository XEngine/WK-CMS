		  ...
		  if ($picrow = $this->getSliderData()) {
			  foreach ($picrow as $row) {
				  $html .= '<div class="item">';
					...
					$html .=  '<img src="' . SITEURL . '/plugins/slidecms/images/video.png" alt="" class="wk image">';
					} else {
					$html .= '<a href="' . SITEURL . '/plugins/' . $sfolder . '/slides/' . $row->data . '" class="lightbox" title="' . $row->{'caption' . Lang::$lang} . '"><img src="' . SITEURL . '/plugins/' . $sfolder . '/slides/' . $row->data . '" alt="" class="wk image"></a>';
					}
					$html .= '<a data-id="' . $row->id . '" data-type="' . $row->data_type . '" data-name="' . $row->{'caption' . Lang::$lang} . '" class="imgdelete wk top right negative corner label"><i class="icon remove sign"></i></a>
					<div class="wk-content">
					  <div contenteditable="true" data-path="false" data-edit-type="cslidecms" data-id="' . $row->id . '" data-key="title" class="wk editable">' . $row->{'caption' . Lang::$lang} . '</div>
					</div>
				  </div>';
			  }
		  }
