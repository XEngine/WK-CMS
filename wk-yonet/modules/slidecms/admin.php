...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_SLC_INFO3;?></div>
  <div class="wk segment">
    <div id="sactions" class="wk buttons push-right"><a data-option="vids" class="wk icon positive button"><i class="icon video"></i> <?php echo Lang::$word->_MOD_SLC_ADD_V;?></a><a data-option="pics" class="wk icon info button"><i class="icon photo"></i> <?php echo Lang::$word->_MOD_SLC_ADD_I;?></a></div>
    <div class="wk header"><?php echo Lang::$word->_MOD_SLC_SUBTITLE3 . $single->title;?></div>
    ...
    <div class="wk form">
      <form id="wk_form" name="wk_form" method="post">
        <div id="vids" class="maction" style="display:none">
          ...
          <p class="wk success message"><?php echo Lang::$word->_MOD_SLC_VID_T;?></p>
          <div class="wk divider"></div>
          <button type="button" name="doVideos" class="wk positive button"><?php echo Lang::$word->_MOD_SLC_ADD2;?></button>
  ...
  <?php endif;?>
  <div id="slidedata" class="wk grid fitted">
    <?php if($sliderdata):?>
    <?php foreach($sliderdata as $row):?>
    <div class="item">
      <?php if($row->data_type == "vid"):?>
      <img src="<?php echo SITEURL;?>/plugins/slidecms/images/video.png" alt="" class="wk image">
      <?php else:?>
      <a href="<?php echo SITEURL . '/plugins/' . $single->plug_name . '/slides/' . $row->data;?>" class="lightbox" title="<?php echo $row->{'caption' . Lang::$lang};?>"><img src="<?php echo SITEURL . '/plugins/' . $single->plug_name . '/slides/' . $row->data;?>" alt="" class="wk image"></a>
      <?php endif;?>
      <a data-id="<?php echo $row->id;?>" data-type="<?php echo $row->data_type;?>" data-name="<?php echo $row->{'caption' . Lang::$lang};?>" class="imgdelete wk top right negative corner label"><i class="icon remove sign"></i></a>
      <div class="wk-content">
        <div contenteditable="true" data-path="false" data-edit-type="cslidecms" data-id="<?php echo $row->id;?>" data-key="title" class="wk editable"><?php echo $row->{'caption' . Lang::$lang};?></div>
      </div>
    </div>
    <?php endforeach;?>
    <?php endif;?>
