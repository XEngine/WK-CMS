...
<div class="wk icon heading message blue"> <a class="helper wk top right info corner label" data-help="blog"><i class="icon help"></i></a> <i class="puzzle piece icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_AM_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE1 . $row->{'title'.Lang::$lang};?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="two fields">
        ...
        <div class="field">
          ...
          <div class="small-top-space">
            <div class="wk normal image"> <a class="lightbox" href="<?php echo SITEURL . '/' . Blog::imagepath . $row->thumb;?>"><img src="<?php echo SITEURL . '/' . Blog::imagepath . $row->thumb;?>" alt="<?php echo $row->thumb;?>"></a> </div>
          </div>
        </div>
      </div>
      <div class="two fields">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_AM_UPDATE;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=blog" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_AM_INFO2. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE2;?></div>
    <div class="wk double fitted divider"></div>
    <form id="wk_form" name="wk_form" method="post">
      <div class="two fields">
        <div class="field">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_AM_ADD;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=blog" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
      <input name="processArticle" type="hidden" value="1">
...
<div class="wk icon heading message blue"> <a class="helper wk top right info corner label" data-help="amconfig"><i class="icon help"></i></a> <i class="puzzle piece icon"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_MOD_AM_TITLE4;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_AM_INFO3. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE9;?></div>
    <div class="wk double fitted divider"></div>
    <form id="wk_form" name="wk_form" method="post">
      <div class="four fields">
        <div class="field">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_AM_UPDATEC;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=blog" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<?php break;?>
<?php case"category": ?>
<div class="wk icon heading message blue"> <a class="helper wk top right info corner label" data-help="amcats"><i class="icon help"></i></a> <i class="puzzle piece icon"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_MOD_AM_TITLE4;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_AM_INFO5;?></div>
  <div id="msgalt"></div>
  <div class="wk-grid">
    <div class="columns small-gutters">
      <div class="screen-60 tablet-50 phone-100">
        <div class="wk segment">
          <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE5;?></div>
          <div class="wk fitted divider"></div>
          <div class="wk form">
            <form id="wk_form" name="wk_form" method="post">
              <div class="field">
              ...
              <div class="wk double fitted divider"></div>
              <button name="docategory" type="button" class="wk positive button"><?php echo Lang::$word->_MOD_AM_CADD;?></button>
              <a href="index.php?do=modules&amp;action=config&amp;modname=blog" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
      ...
      <div class="screen-40 tablet-50 phone-100">
        <div class="wk block header">
          <h4><?php echo Lang::$word->_MOD_AM_CATEGORIES;?></h4>
        </div>
        <div id="menusort"> <?php echo Registry::get("Blog")->getSortCatList();?></div>
        <div class="sholder push-right"><a id="serialize" class="wk positive right labeled icon button"><i class="icon ok sign"></i><?php echo Lang::$word->_MOD_AM_POS_SAVE;?></a></div>
      </div>
    </div>
  </div>
</div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MU_INFO1;?></div>
  <div id="msgalt"></div>
  <div class="wk-grid">
    <div class="columns small-gutters">
      <div class="screen-60 tablet-50 phone-100">
        <div class="wk segment">
          <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE6 . $row->{'name'.Lang::$lang};?></div>
          <div class="wk fitted divider"></div>
          <div class="wk form">
            <form id="wk_form" name="wk_form" method="post">
              <div class="field">
              ...
              <div class="wk double fitted divider"></div>
              <button name="docategory" type="button" class="wk positive button"><?php echo Lang::$word->_MOD_AM_CAUPDATE;?></button>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_AM_INFO8;?></div>
  <div class="wk segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE8;?></div>
    <div class="wk fitted divider"></div>
        ...
        <tfoot>
          <tr>
            <td colspan="6"><div class="wk small buttons">
                <button type="submit" name="approve" class="wk positive button"><i class="add icon"></i> <?php echo Lang::$word->_MOD_AM_APPROVE;?></button>
                <button type="submit" name="disapprove" class="wk warning button"><i class="minus icon"></i> <?php echo Lang::$word->_MOD_AM_DISAPPROVE;?></button>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_AM_INFO4;?></div>
  <div class="wk segment">
    ...
    <div class="wk header"><?php echo Lang::$word->_MOD_AM_SUBTITLE3;?></div>
    <div class="wk fitted divider"></div>
    <div class="wk small form basic segment">
      <form method="post" id="wk_form" name="wk_form">
        <div class="four fields">
          ...
          <div class="field">
            <div class="wk action input"> <i class="icon-prepend icon calendar"></i>
              <input name="enddate" type="text" data-datepicker="true" placeholder="<?php echo Lang::$word->_UR_SHOW_TO;?>" id="enddate" />
              <a id="doDates" class="wk icon button"><?php echo Lang::$word->_SR_SEARCH_GO;?></a> </div>
          </div>
          <div class="field">
    ...
    <table class="wk sortable table">
      ...
      <tbody>
        ...
        <tr<?php if($row->is_user):?> class="warning"<?php endif;?>>
          <td><a class="lightbox" href="<?php echo SITEURL . '/' . Blog::imagepath . $row->thumb;?>" title="<?php echo $row->{'title'.Lang::$lang};?>"> <img src="<?php echo SITEURL;?>/thumbmaker.php?src=<?php echo SITEURL . '/' . Blog::imagepath . $row->thumb;?>&amp;w=120&amp;h=60" alt="" class="wk image"></a></td>
          ...
          <td><span class="wk black label"><?php echo $row->totalcomments;?></span></td>
