...
<div class="wk icon heading message blue"> <a class="helper wk top right info corner label" data-help="events"><i class="icon help"></i></a> <i class="puzzle piece icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_EM_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_EM_SUBTITLE1 . $row->{'title'.Lang::$lang};?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_EM_UPDATE;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=events" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_EM_INFO2. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_EM_SUBTITLE2;?></div>
    <div class="wk double fitted divider"></div>
    <form id="wk_form" name="wk_form" method="post">
      <div class="two fields">
        <div class="field">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_MOD_EM_ADD;?></button>
      <a href="index.php?do=modules&amp;action=config&amp;modname=events" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
      <input name="processEvent" type="hidden" value="1">
    </form>
  </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_EM_INFO4;?></div>
  <div class="wk segment">
    <div class="wk header"><?php echo Lang::$word->_MOD_EM_VIEWCAL2;?></div>
    <div class="wk fitted divider"></div>
    <div id="calendar">
      ...
      $("#calendar").on("click", "a.changedate", function () {
          ...
          $.ajax({
              ...
              success: function (data) {
				  ...
				  $('.wk.segment').removeClass('loading');
              }
          });
          return false;
      });
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MOD_EM_INFO3;?></div>
  <div class="wk segment">
    <div class="wk buttons push-right"> <a href="<?php echo Core::url("modules", "view");?>" class="wk positive button"><i class="icon add"></i><?php echo Lang::$word->_MOD_EM_VIEWCAL;?></a> <a href="<?php echo Core::url("modules", "add");?>" class="wk info button"><i class="icon add"></i><?php echo Lang::$word->_MOD_EM_ADD;?></a> </div>
    <div class="wk header"><?php echo Lang::$word->_MOD_EM_SUBTITLE3;?></div>
    <div class="wk fitted divider"></div>
