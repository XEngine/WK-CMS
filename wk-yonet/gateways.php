...
<div class="wk icon heading message coral"><a class="helper wk top right info corner label" data-help="gateway"><i class="icon help"></i></a> <i class="share icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_GW_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_GW_SUBTITLE1 . $row->displayname;?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_GW_UPDATE;?></button>
      <a href="index.php?do=gateways" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<div class="wk icon heading message coral"> <i class="icon share"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_GW_TITLE2;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_GW_INFO2;?></div>
  <div class="wk segment">
    <div class="wk header"><?php echo Lang::$word->_GW_SUBTITLE2;?></div>
