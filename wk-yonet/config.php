...
?>
<div class="wk icon heading message mortar"><a class="helper wk top right info corner label" data-help="configure"><i class="icon help"></i></a> <i class="setting icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_CG_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_CG_SUBTITLE1;?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="two fields">
        ...
        <div class="field">
          ...
          <select name="theme" id="themeswitch">
            ...
            <?php getTemplates(THEMEPATH."/theme/", $core->theme)?>
          </select>
        </div>
      </div>
      <div class="two fields">
        <div class="field">
          ...
          <label class="input">
            <input type="file" id="bgimage" name="bgimg" class="filefield">
          </label>
        </div>
        <div class="field">
      ...
      <div class="two fields">
        <div class="field">
          ...
          <label class="input">
            <input type="file" id="logoid" name="logo" class="filefield">
          </label>
        </div>
        <div class="field">
          <div class="two fields">
      ...
      <div class="wk fitted divider"></div>
      <div class="two fields wk positive segment offline-data"<?php echo ($core->offline) ? "" : " style=\"display:none\""; ?>>
        <div class="field">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_CG_UPDATE;?></button>
