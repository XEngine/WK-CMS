...
<div class="wk icon heading message sky"><a class="helper wk top right info corner label" data-help="menu"><i class="icon help"></i></a> <i class="reorder icon"></i>
  <div class="content">
    ...
    <div class="columns small-gutters">
      <div class="screen-60 tablet-50 phone-100">
        <div class="wk segment">
          <div class="wk header"><?php echo Lang::$word->_MU_SUBTITLE1 . $row->{'name'.Lang::$lang};?></div>
          ...
          <div class="wk form">
            <form id="wk_form" name="wk_form" method="post">
              ...
              <button name="domenu" type="button" class="wk positive button"><?php echo Lang::$word->_MU_UPDATE;?></button>
              <a href="index.php?do=menus" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
      ...
      <div class="screen-40 tablet-50 phone-100">
        ...
        <div class="sholder push-right"><a id="serialize" class="wk positive right labeled icon button"><i class="icon ok sign"></i><?php echo Lang::$word->_MU_SAVE;?></a></div>
      </div>
    </div>
  </div>
</div>
<?php break;?>
<?php default: ?>
<div class="wk icon heading message sky"><a class="helper wk top right info corner label" data-help="menu"><i class="icon help"></i></a> <i class="icon reorder"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_MU_TITLE2;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_MU_INFO2;?></div>
  <div id="msgalt"></div>
  <div class="wk-grid">
    <div class="columns small-gutters">
      <div class="screen-60 tablet-50 phone-100">
        <div class="wk segment">
          <div class="wk header"><?php echo Lang::$word->_MU_SUBTITLE2;?></div>
          <div class="wk fitted divider"></div>
          <div class="wk form">
            <form id="wk_form" name="wk_form" method="post">
              <div class="field">
              ...
              <div class="wk double fitted divider"></div>
              <button name="domenu" type="button" class="wk positive button"><?php echo Lang::$word->_MU_ADD;?></button>
              <input name="processMenu" type="hidden" value="1">
            </form>
          </div>
        </div>
