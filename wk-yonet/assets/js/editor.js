...
(function($) {
    ...
    $.Redactor.opts = {
        ...
        buttons: ['html', 'formatting', 'bold', 'italic', 'deleted', 'unorderedlist', 'orderedlist', 'outdent', 'indent', /*'image',*/ 'manager', 'video', 'file', 'table', 'link', 'alignment', '|', 'horizontalrule'], // 'underline', 'alignleft', 'aligncenter', 'alignright', 'justify'
        buttonsHideOnMobile: [],
        ...
        langs: {
            en: {
                ...
                unlink: 'Unlink',
                ilink: 'Internal Link',
                ilink_select: 'Select Internal Link',
                link_insert: 'Insert link',
                ...
                img_new_tab: 'Open image in lightbox',
                underline: 'Underline',
                alignment: 'Alignment',
    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        tableInsert: function() {
            ...
            var rows = $('#redactor_table_rows').val(),
                ...
                $table = $('<table id="table' + tableId + '" class="wk table"><tbody></tbody></table>'),
                i, $row, z, $column;
        ...
        videoInsert: function() {
            ...
            var iframeStart = '<div class="responsive-video"><iframe src="',
        ...
        imageEdit: function(image) {
            ...
            var callback = $.proxy(function() {
                ...
                $("#redactor_form_image_align").chosen({
		...
		modalTemplatesInit: function()
		{
			$.extend( this.opts,
			{
				...
				+ '<section id="redactor-modal-image-edit" class="wk form">'
					...
					+ '<input type="text" id="redactor_file_link" class="redactor_input" /></div>'
					+ '<div class="field"><label class="checkbox"><input type="checkbox" id="redactor_link_blank"> <i></i>' + this.opts.curLang.img_new_tab + '</label></div>'
					+ '<div class="field"><label>' + this.opts.curLang.image_position + '</label>'
				...
				+ '<section class="footer">'
					+ '<div class="wk three fluid buttons">'
					+ '<button class="redactor_btn_modal_close wk negative button" id="redactor_image_delete_btn">' + this.opts.curLang.remove + '</button>'
					+ '<button class="redactor_btn_modal_close wk warning button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wk positive button" id="redactorSaveBtn">' + this.opts.curLang.save + '</button>'
					+ '</div>'
				+ '</section>',
				...
				+ '<section class="footer">'
					...
					+ '<button class="redactor_btn_modal_close wk negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wk positive button" id="redactor_upload_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',

				modal_link: String()
				+ '<section id="redactor-modal-link-insert" class="wk form">'
					+ '<div class="field"><label>' + this.opts.curLang.ilink + '</label>'
					+ '<select id="redactor-predefined-links"></select></div>'
					+ '<div class="field"><label>URL</label>'
					+ '<input type="text" class="redactor_input" id="redactor_link_url" /></div>'
					+ '<div class="field"><label>' + this.opts.curLang.text + '</label>'
					+ '<input type="text" class="redactor_input" id="redactor_link_url_text" /></div>'
					+ '<div class="field"><label class="checkbox">'
					+ '<input type="checkbox" id="redactor_link_blank"> <i></i>' + this.opts.curLang.link_new_tab
					+ '</label></div>'
				+ '</section>'
				+ '<section class="footer">'
					+ '<div class="wk two fluid buttons">'
					+ '<button class="redactor_btn_modal_close wk negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wk positive button" id="redactor_insert_link_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',

				modal_table: String()
				+ '<section id="redactor-modal-table-insert" class="wk form">'
				    + '<div class="two fields">'
					+ '<div class="field"><label>' + this.opts.curLang.rows + '</label>'
					+ '<input type="text" size="5" value="2" id="redactor_table_rows"></div>'
					+ '<div class="field"><label>' + this.opts.curLang.columns + '</label>'
					+ '<input type="text" size="5" value="3" id="redactor_table_columns"</div>'
					+ '</div>'
				+ '</section>'
				+ '<section class="footer">'
					+ '<div class="wk two fluid buttons">'
					+ '<button class="redactor_btn_modal_close wk negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wk positive button" id="redactor_insert_table_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',

				modal_video: String()
				+ '<section id="redactor-modal-video-insert">'
					+ '<form id="redactorInsertVideoForm" class="wk form">'
						+ '<div class="field"><label>' + this.opts.curLang.video_html_code + '</label>'
						+ '<textarea id="redactor_insert_video_area"></textarea></div>'
					+ '</form>'
				+ '</section>'
				+ '<section class="footer">'
					+ '<div class="wk two fluid buttons">'
					+ '<button class="redactor_btn_modal_close wk negative button">' + this.opts.curLang.cancel + '</button>'
					+ '<button class="redactor_modal_action_btn wk positive button" id="redactor_insert_video_btn">' + this.opts.curLang.insert + '</button>'
					+ '</div>'
				+ '</section>',
			   ...
			   + '<div id="redactor_tabs">' 
				+ '<a href="#" class="redactor_tabs_act">' + this.opts.curLang.browseFiles + '</a>' 
				+ '<a href="#">' + this.opts.curLang.uploadFiles + '</a>' 
				+ '</div>' 
				+ '<div id="redactor_tab1" class="redactor_tab wk segment full fit form">' 
				+ '<div data-modal-select="true" class="wk fluid selection dropdown">' 
				+ '<input name="directory" type="hidden" value="">' 
				+ '<div class="text">Select Directory</div>' 
				+ ' <i class="dropdown icon"></i>' 
				+ '<div class="menu">' 
				+ '<div class="item" data-value=""><i class="icon home"></i> Home Directory</div>' 
				+ '</div>' 
				+ '</div>' 
				+ '<div class="wk divider"></div>' 
				+ '<div class="file_wrapper" style="overflow:auto;height: 300px;">' 
				+ '<ul class="filegrid clearfix"></ul>' 
				+ '</div>' 
				+ '</div>' 
				+ ' <div id="redactor_tab2" class="redactor_tab wk segment full fit form" style="display: none;">' 
				+ '<div id="uploader">' 
				+ '<form id="upload" method="post" action="controller.php" enctype="multipart/form-data">' 
				+ '<div id="drop"> ' + this.opts.curLang.drop_file_here + ' <a id="upl">' + this.opts.curLang.browse + '</a>' 
        ...
        managerInit: function() {
            ...
            var callback = $.proxy(function() {
                $('.filegrid').on('click', 'li img.item', $.proxy(function(e) {
                    //$('#cms_files [data-title]').popup('remove');
                    $items = e.target;
                    ...
                    if (type === "image") {
                        html = '<img id="image-marker" src="../uploads/' + path + name + '" alt="' + title + '">';
                    } else {
                        html = '<a href="../uploads/' + path + name + '" >' + title + '</a>';
                    }

                    //this.sync();
                    this.insertFile(html);
            ...
            this.modalInit(this.opts.curLang.manager, this.opts.modal_manager, 620, callback);
            this.getFolders();
            this.getFiles();
            this.fileUpload();
        },
        insertFile: function(html) {
            this.selectionRestore();
            this.execCommand('inserthtml', html, false);
            var image = $(this.$editor.find('img#image-marker'));
            if (image.length) image.removeAttr('id');
        ...
        fileUpload: function() {
            ...
            $('#upload').fileupload({
                ...
                add: $.proxy(function(e, data) {
                    var tpl = $('<li class="working"><input type="text" value="0" data-width="48" data-height="48" data-fgColor="#3498DB" data-readOnly="1" data-bgColor="#ffffff" /><p><small></small></p><span></span></li>');

                    tpl.find('p').text(data.files[0].name)
                        .append('<small></small>')
                        .append('<i>' + this.formatFileSize(data.files[0].size) + '</i>');
        ...
        getFiles: function() {
            $.ajax({
                ...
                beforeSend: function() {
                    $("#cms_files .wk.form").addClass('loading');
                },
                success: function(json) {
                    if (json.type == "success") {
                        setTimeout(function() {
                            $("#cms_files .wk.form").removeClass('loading');
                        }, 250);
                        $("#cms_files ul.filegrid").html(json.message);
                        //$('body [data-content]').popover({trigger: 'hover', placement: 'auto'});
                        //$('#cms_files [data-title]').popup({
                        // variation: 'inverted'
                        //});
                    }
