...
<div class="wk icon heading message coral"> <i class="payment icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_TR_INFO2;?></div>
  <div class="wk form segment">
    <div data-select-range="true" class="wk selection dropdown push-right push-right">
    ...
    <div class="wk header"><?php echo Lang::$word->_TR_SALES3 . ' &rsaquo; ' . $core->year;?></div>
...
<div class="wk icon heading message coral"> <i class="icon payment"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_TR_TITLE1;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_TR_INFO1;?></div>
  <div class="wk segment">
    <div class="wk positive right pointing dropdown icon button push-right"> <i class="reorder icon"></i>
    ...
    <div class="wk header"><?php echo Lang::$word->_TR_SUBTITLE1;?></div>
    <div class="wk fitted divider"></div>
    ...
    <table class="wk sortable table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="wk positive label"><?php echo $row->pp;?></span></td>
