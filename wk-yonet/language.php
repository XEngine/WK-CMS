...
<div class="wk icon heading message mortar"> <i class="chat icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_LA_INFO1. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_LA_SUBTITLE1 . $row->name;?></div>
    ...
    <form id="wk_form" name="wk_form" method="post">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_LA_UPDATE;?></button>
      <a href="index.php?do=language" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<?php break;?>
<?php case "add": ?>
<div class="wk icon heading message mortar"><a class="helper wk top right info corner label" data-help="language"><i class="icon help"></i></a> <i class="chat icon"></i>
  <div class="content">
    <div class="header"> <?php echo Lang::$word->_LA_TITLE3;?> </div>
    <div class="wk breadcrumb"><i class="icon home"></i> <a href="index.php" class="section"><?php echo Lang::$word->_N_DASH;?></a>
      <div class="divider"> / </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_LA_INFO2. Lang::$word->_REQ1 . '<i class="icon asterisk"></i>' . Lang::$word->_REQ2;?></div>
  <div class="wk form segment">
    <div class="wk header"><?php echo Lang::$word->_LA_SUBTITLE2;?></div>
    <div class="wk double fitted divider"></div>
    <form id="wk_form" name="wk_form" method="post">
      <div class="two fields">
        <div class="field">
      ...
      <div class="wk double fitted divider"></div>
      <button type="button" name="dosubmit" class="wk positive button"><?php echo Lang::$word->_LA_ADD;?></button>
      <a href="index.php?do=language" class="wk basic button"><?php echo Lang::$word->_CANCEL;?></a>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_LA_INFO4;?></div>
  <div class="wk form stacked segment">
    <div class="wk header"><?php echo Lang::$word->_LA_SUBTITLE4;?> / <span id="langname"><?php echo Lang::$word->_LA_MAIN;?></span></div>
    <div class="wk double fitted divider"></div>
    <div class="two fields">
      <div class="field">
  ...
  <div id="mainsegment" class="wk form segment">
    <div class="wk-grid">
      <div id="langphrases" class="two columns small-gutters">
        ...
        <div class="row">
          <div contenteditable="true" data-path="lang" data-edit-type="language" data-id="<?php echo $i++;?>" data-key="<?php echo $pkey['data'];?>" class="wk phrase"><?php echo $pkey;?></div>
        </div>
        <?php endforeach;?>
      </div>
    </div>
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_LA_INFO3;?></div>
  <div class="wk segment"> <a class="wk icon positive button push-right" href="index.php?do=language&amp;action=add"><i class="icon add"></i> <?php echo Lang::$word->_LA_ADD_NEW;?></a>
    <div class="wk header"><?php echo Lang::$word->_LA_SUBTITLE3;?></div>
