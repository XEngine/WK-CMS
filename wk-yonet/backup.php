...
?>
<div class="wk icon heading message mortar"><a class="helper wk top right info corner label" data-help="backup"><i class="icon help"></i></a> <i class="hdd icon"></i>
  <div class="content">
...
<div class="wk-large-content">
  <div class="wk message"><?php echo Core::langIcon();?><?php echo Lang::$word->_BK_INFO1;?></div>
  <div class="wk segment"><a class="wk icon positive button push-right" href="index.php?do=backup&amp;create=1"><i class="icon add"></i> <?php echo Lang::$word->_BK_CREATE;?></a>
    <div class="wk header"><?php echo Lang::$word->_BK_SUBTITLE1;?></div>
